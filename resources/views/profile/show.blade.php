                ...
                <div class="grid lg:grid-cols-[260px,1fr] gap-8">
                    <aside class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/60 p-6 h-fit sticky top-6" style="animation: fade-in-up 0.7s ease forwards;">
                        ...
                        <div class="space-y-1 text-sm font-semibold text-brew-brown">
                            ...
                            <a href="{{ route('profile.show') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all bg-brew-brown text-white shadow-md">
                                <span class="w-8 h-8 rounded-lg bg-white/15 flex items-center justify-center">
                                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4z"></path><path d="M6 20c0-2.21 2.69-4 6-4s6 1.79 6 4"></path></svg>
                                </span>
                                Profile
                            </a>
                        </div>
                    ...
                    <main class="space-y-6" style="animation: fade-in-up 0.8s ease forwards;">
                        <div class="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/60">
                            <div class="flex items-center justify-between mb-6">
                                <div>
                                    <p class="text-xs uppercase text-gray-500">Account</p>
                                    <h1 class="text-2xl font-bold text-brew-brown">My Profile</h1>
                            ...
                            @if(session('status'))
                                <div class="mb-6">
                                    <div class="bg-green-50 border-l-4 border-green-400 p-4 rounded-xl shadow">
                            ...
                            <div class="space-y-6">
                                @if (Laravel\Fortify\Features::canUpdateProfileInformation())
                                    <div class="bg-white/90 backdrop-blur-lg shadow rounded-2xl border border-brew-light-brown/20 overflow-hidden">
