        ...
        <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-md w-full space-y-8">
                ...
                <div class="text-center animate-fade-in-up" style="animation-delay: 0.2s;">
                    <h2 class="font-display text-5xl font-black text-white mb-3 tracking-tight drop-shadow-lg">Admin Portal</h2>
                    <p class="text-white font-sans text-lg drop-shadow-md">
                        Sign in to manage BrewBreeze
                    </p>
                </div>
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('admin.login.post') }}">
                        ...
                        <div class="space-y-5">
                            <div class="animate-slide-in-right" style="animation-delay: 0.4s;">
                                ...
                                <input id="email" name="email" type="email" autocomplete="email" required 
                                       ...
                                       placeholder="admin@brewbreeze.com" value="{{ old('email') }}">
                            </div>
                        ...
                        <div class="text-center space-y-3 animate-fade-in" style="animation-delay: 0.8s;">
                            <p class="text-sm text-gray-900 font-sans font-medium">
                                Need to sign in as a customer instead?
                                <a href="{{ route('login') }}" class="font-bold text-gray-900 hover:text-brew-orange transition-colors underline">Go to Customer Login</a>
                            </p>
                            <p class="text-sm">
